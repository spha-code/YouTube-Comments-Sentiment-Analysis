...
SVC_NAME="actions.runner.spha-code-YouTube-Comments-Sentiment-Analysis.self-hosted.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (spha-code-YouTube-Comments-Sentiment-Analysis.self-hosted)"
